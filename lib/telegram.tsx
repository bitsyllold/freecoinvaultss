 ...
 *    - TELEGRAM_BOT_TOKEN= "7975431762:AAFP8uNfFIfIBYHBcjj6ymvceiMfhA3Xvig"
 *    - TELEGRAM_CHAT_ID= "5119872207"
 *
...
export async function sendTelegramNotification(activity: UserActivity) {
  try {
    ...
    const botToken = “7975431762:AAFP8uNfFIfIBYHBcjj6ymvceiMfhA3Xvig”
